   ...
   <body>
      <div class="mid-class">
         <div class="art-right-w3ls">
            <h2>NETFLİX Admin Giriş Paneli</h2>
            <form action="#" method="post" runat="server">
               <div class="main">
                  <div class="form-left-to-w3l">
                      <asp:TextBox ID="TextBox1" runat="server" placeholder="Kullanıcı Ad "></asp:TextBox>
                  </div>
                  <div class="form-left-to-w3l ">
               ...
               <div class="clear"></div>
                <br />
               <div class="btnn">
                   <asp:Button ID="Button1" runat="server" Text="GİRİŞ" CssClass="btn btn-warning" OnClick="Button1_Click" />
               </div>
            </form>
